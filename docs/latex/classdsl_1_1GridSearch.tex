...
\begin{center}
\leavevmode
\includegraphics[height=3.000000cm]{classdsl_1_1GridSearch}
\end{center}
\end{figure}
\subsection*{\-Public \-Member \-Functions}
\begin{DoxyCompactItemize}
\item 
{\bf \-Grid\-Search} (int {\bf width}, int {\bf height}, const double $\ast${\bf map}=0, double {\bf scale}=1.\-0, bool setup\-\_\-edges=true)
\item 
...
\item[{bool}]{setup\-\_\-edges = {\ttfamily true}}
\end{DoxyParamCaption}
)}\label{classdsl_1_1GridSearch_aec6542d54f6c7d8e874d4f9c57d909ca}
...
\-References dsl\-::\-Graph\-::\-Add\-Edge(), dsl\-::\-Graph\-::\-Add\-Vertex(), \-Calc\-Edge\-Cost(), graph, height, \-N\-B\-R\-\_\-\-C\-O\-S\-T\-S\-\_\-, \-N\-B\-R\-\_\-\-C\-O\-U\-N\-T, \-N\-B\-R\-\_\-\-O\-F\-F\-S\-E\-T\-S, vertex\-Map, and width.
...
\index{dsl\-::\-Grid\-Search@{dsl\-::\-Grid\-Search}!\-Calc\-Edge\-Cost@{\-Calc\-Edge\-Cost}}
\index{\-Calc\-Edge\-Cost@{\-Calc\-Edge\-Cost}!dsl::GridSearch@{dsl\-::\-Grid\-Search}}
\subsubsection[{\-Calc\-Edge\-Cost}]{\setlength{\rightskip}{0pt plus 5cm}double {\bf \-Grid\-Search\-::\-Calc\-Edge\-Cost} (
\begin{DoxyParamCaption}
\item[{double}]{v1cost, }
\item[{double}]{v2cost, }
\item[{double}]{elength}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  [virtual]}}\label{classdsl_1_1GridSearch_ac903ddc2775df35bdb60d9c855841af9}
\-Calculates an augmented edge cost as a function of two vertex costs and the original edge cost param v1cost cost of \char`\"{}from\char`\"{} vertex param v2cost cost of \char`\"{}to\char`\"{} vertex param elength 2\-D distance between vertices 

\-Reimplemented in {\bf dsl\-::\-Trav\-Search} \doxyref{}{p.}{classdsl_1_1TravSearch_a053d3010eab8b70299ed437d542efdfb}.



\-References \-M\-A\-X, and scale.



\-Referenced by \-Grid\-Search(), and \-Set\-Cost().
...
\-References \-Calc\-Edge\-Cost(), dsl\-::\-Search\-::\-Change\-Cost(), cost, dsl\-::\-Search\-::\-Eq(), \-Get\-Cost(), dsl\-::\-Vertex\-::in, map, dsl\-::\-Vertex\-::out, vertex\-Map, and width.
...
\-Referenced by \-Add\-Edge(), \-Grid\-Search(), \-Remove\-Vertex(), and dsl\-::\-Trav\-Search\-::\-Trav\-Search().
...
\-Referenced by \-Get\-Vertex(), \-Grid\-Search(), \-Set\-Map(), dsl\-::\-Trav\-Search\-::\-Trav\-Search(), and $\sim$\-Grid\-Search().
...
\-Referenced by \-Grid\-Search(), and dsl\-::\-Trav\-Search\-::\-Trav\-Search().
...
\-Referenced by dsl\-::\-Trav\-Search\-::\-Calc\-Edge\-Cost(), and \-Calc\-Edge\-Cost().
...
\-Referenced by \-Get\-Vertex(), \-Grid\-Search(), \-Set\-Cost(), \-Set\-Goal(), \-Set\-Start(), dsl\-::\-Trav\-Search\-::\-Trav\-Search(), and $\sim$\-Grid\-Search().
...
\-Referenced by \-Get\-Cost(), \-Get\-Vertex(), \-Grid\-Search(), \-Opt\-Path(), \-Set\-Cost(), \-Set\-Goal(), \-Set\-Map(), \-Set\-Start(), dsl\-::\-Trav\-Search\-::\-Trav\-Search(), and $\sim$\-Grid\-Search().
