...
#ifndef DSL_CARCONNWITHPRIM_H
#define DSL_CARCONNWITHPRIM_H
 ...
 */
class CarConnWithPrim: public GridConnectivity< Eigen::Vector3d, Eigen::Matrix3d, SE2Prim > {
public:
   ...
   */
  CarConnWithPrim(const CarGrid& grid, CarPrimitiveCfg& cfg);
   ...
   */
  CarConnWithPrim(const CarGrid& grid,
